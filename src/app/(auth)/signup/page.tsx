...
export default function SignupPage() {
  ...
  if (success) {
    return (
      ...
      >
        <div className="bg-ivory rounded-2xl border border-sand/60 shadow-warm-md px-7 py-12">
          <CheckCircle2 className="h-10 w-10 text-sage mx-auto mb-4" strokeWidth={1.5} />
          <h2 className="font-display text-xl text-espresso mb-2">Account created!</h2>
  ...
  return (
    ...
    >
      ...
      <div className="bg-ivory rounded-2xl border border-sand/60 shadow-warm-md px-7 py-8">
        <h2 className="font-display text-xl text-espresso mb-6">Create your account</h2>
        ...
        <p className="mt-5 text-xs text-center text-warm-gray">
      ...
      <p className="mt-5 text-center text-sm text-warm-gray">
        ...
        <Link href="/login" className="text-gold hover:text-gold-dark font-medium transition-colors">
          Sign in
        </Link>
      </p>
    </motion.div>
